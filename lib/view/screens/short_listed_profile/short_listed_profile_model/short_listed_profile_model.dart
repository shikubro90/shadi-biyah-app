...
class ShortListProfileModel {
  int? code;
  String? message;
  Data? data;

  ShortListProfileModel({
    this.code,
    this.message,
    this.data,
  });

  factory ShortListProfileModel.fromRawJson(String str) =>
      ShortListProfileModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ShortListProfileModel.fromJson(Map<String, dynamic> json) =>
      ShortListProfileModel(
        code: json["code"],
